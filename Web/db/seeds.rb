...
couch_post = CouchPost.find_or_create_by!(title: 'Casa rodante completamente equipada', description: 'Ofrezco alojamiento y pago a cambio de colaboración con proyecto personal de Química. Cuantas menos cosas preguntes, mejor nos vamos a llevar.', couch_type_id: 6, username: 'Heisenberg', rooms: 1, vacants: 1, zone:'Los Hornos')
puts 'CREATED COUCH POST: ' << couch_post.title
